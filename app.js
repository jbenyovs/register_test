...
const createMeetingDestinationElm = document.querySelector(
  "#create-meeting-destination"
);
...
const meetingsJoinModeratorElm = document.querySelector(
  "#meetings-join-moderator"
);
...
const meetingsCurrentDetailsElm = document.querySelector(
  "#meetings-current-details"
);
...
function generateMeetingsListItem(meeting) {
  ...
  detailsElm.innerText = meeting.destination || meeting.sipUri || meeting.id;
  ...
  webex.meetings
    ...
    .then(() => {
      ...
      Object.keys(meetings).forEach(key => {
        meetingsListElm.appendChild(generateMeetingsListItem(meetings[key]));
      });
    });
}

function createMeeting() {
  webex.meetings.create(createMeetingDestinationElm.value).then(meeting => {
    generalStartReceivingTranscription.disabled = false; // eslint-disable-line no-use-before-define
    ...
    meetingsListElm.appendChild(generateMeetingsListItem(meeting));
  });
}
...
function joinMeeting(meetingId) {
  ...
  meeting.join(joinOptions).then(() => {
    meetingsCurrentDetailsElm.innerText =
      meeting.destination || meeting.sipUri || meeting.id;
...
const generalStartReceivingTranscription = document.querySelector(
  "#gc-start-receiving-transcription"
);
const generalStopReceivingTranscription = document.querySelector(
  "#gc-stop-receiving-transcription"
);
const generalTranscriptionContent = document.querySelector(
  "#gc-transcription-content"
);

const sourceDevicesGetMedia = document.querySelector("#sd-get-media-devices");
const sourceDevicesAudioInput = document.querySelector(
  "#sd-audio-input-devices"
);
const sourceDevicesAudioOutput = document.querySelector(
  "#sd-audio-output-devices"
);
const sourceDevicesVideoInput = document.querySelector(
  "#sd-video-input-devices"
);
const sourceDeviceControls = document.querySelector("#source-devices-controls");
const receivingSourcesControls = document.querySelector(
  "#receiving-sources-controls"
);
const audioInputDeviceStatus = document.querySelector(
  "#sd-audio-input-device-status"
);
const audioOutputDeviceStatus = document.querySelector(
  "#sd-audio-output-device-status"
);
const videoInputDeviceStatus = document.querySelector(
  "#sd-video-input-device-status"
);
...
const toggleSourcesMediaDirection = document.querySelectorAll(
  "[name=ts-media-direction]"
);
const toggleSourcesSendAudioStatus = document.querySelector(
  "#ts-toggle-audio-status"
);
const toggleSourcesSendVideoStatus = document.querySelector(
  "#ts-toggle-video-status"
);
const toggleSourcesSendShareStatus = document.querySelector(
  "#ts-screenshare-status"
);

const toggleSourcesQualityStatus = document.querySelector(
  "#ts-sending-quality-status"
);
const toggleSourcesMeetingLevel = document.querySelector(
  "#ts-sending-qualities-list"
);
...
function getMediaSettings() {
  ...
  toggleSourcesMediaDirection.forEach(options => {
    ...
    if (options.sendShare && (isSafari || isiOS)) {
      ...
      console.warn(
        "MeetingControsl#getMediaSettings() :: Please call `meeting.shareScreen()` after joining the meeting"
      );
    }
  });
  ...
  if (meeting) {
    ...
    meeting
      ...
      .then(() => {
        ...
        console.log(
          "MeetingControls#lockMeeting() :: successfully locked meeting"
        );
      })
      .catch(error => {
  ...
  if (meeting) {
    ...
    meeting
      ...
      .then(() => {
        ...
        console.log(
          "MeetingControls#unlockMeeting() :: successfully unlocked meeting"
        );
      })
      .catch(error => {
        generalControlsLockStatus.innerText = "Error! See console for details.";
        console.log(
          "MeetingControls#unlockMeeting() :: unable to unlock meeting."
        );
        console.error(error);
      });
  } else {
  ...
  if (meeting) {
    ...
    meeting
      ...
      .then(() => {
        ...
        console.log(
          "MeetingControls#startRecording() :: meeting recording started!"
        );
      })
      .catch(error => {
        generalControlsRecStatus.innerText = "Error! See console for details.";
        console.log(
          "MeetingControls#startRecording() :: unable to record meeting."
        );
        console.error(error);
      });
  } else {
...
function startReceivingTranscription() {
  ...
  if (meeting) {
    ...
    meeting.on("meeting:receiveTranscription:stopped", () => {
      generalStartReceivingTranscription.innerHTML =
        "start receiving transcription (click me before joining)";
      generalTranscriptionContent.innerHTML =
        "Transcription Content: Webex Assistant must be enabled, check the console!";
    });
  } else {
    console.log("MeetingControls#startRecording() :: no valid meeting object!");
  }
  ...
  if (meeting) {
    ...
    meeting
      ...
      .then(() => {
        ...
        console.log(
          "MeetingControls#pauseRecording() :: meeting recording paused!"
        );
      })
      .catch(error => {
        generalControlsRecStatus.innerText = "Error! See console for details.";
        console.log(
          "MeetingControls#pauseRecording() :: unable to pause recording."
        );
        console.error(error);
      });
  } else {
  ...
  if (meeting) {
    ...
    meeting
      ...
      .then(() => {
        ...
        console.log(
          "MeetingControls#resumeRecording() :: meeting recording resumed!"
        );
      })
      .catch(error => {
        generalControlsRecStatus.innerText = "Error! See console for details.";
        console.log(
          "MeetingControls#resumeRecording() :: unable to resume recording."
        );
        console.error(error);
      });
  } else {
    console.log(
      "MeetingControls#resumeRecording() :: no valid meeting object!"
    );
  }
}
  ...
  if (meeting) {
    ...
    meeting
      ...
      .then(() => {
        ...
        console.log(
          "MeetingControls#stopRecording() :: meeting recording stopped!"
        );
      })
      .catch(error => {
        generalControlsRecStatus.innerText = "Error! See console for details.";
        console.log(
          "MeetingControls#stopRecording() :: unable to stop recording!"
        );
        console.error(error);
      });
  } else {
...
function sendDtmfTones() {
  ...
  if (!tones) {
    ...
    generalControlsDtmfStatus.innerText =
      "Please enter DTMF tones and try again.";
  ...
  if (meeting) {
    ...
    meeting
      ...
      .catch(error => {
        ...
        console.log(
          "MeetingControls#sendDtmfTones() :: unable to send DTMF tones!"
        );
        console.error(error);
      });
  } else {
...
function getMediaStreams(
  ...
  if (!meeting) {
    console.log(
      "MeetingControls#getMediaStreams() :: no valid meeting object!"
    );
  ...
  return meeting
    .getMediaStreams(mediaSettings, audioVideoInputDevices)
    .then(([localStream, localShare]) => {
      console.log(
        "MeetingControls#getMediaStreams() :: Successfully got following streams",
        localStream,
        localShare
      );
       ...
       */
      currentMediaStreams = [
        localStream || currLocalStream,
        localShare || currLocalShare
      ];
    ...
    .catch(error => {
      console.log(
        "MeetingControls#getMediaStreams() :: Error getting streams!"
      );
      console.error();
...
function getMediaDevices() {
  ...
  if (meeting) {
    ...
    console.log(
      "MeetingControls#getMediaDevices() :: no valid meeting object!"
    );
  }
}
...
function setVideoInputDevice() {
  ...
  if (meeting) {
    ...
    getMediaStreams({ sendVideo, receiveVideo }, { video })
      ...
      .catch(error => {
        console.log(
          "MeetingControls#setVideoInputDevice :: Unable to set video input device"
        );
        console.error(error);
      });
  } else {
...
function setAudioInputDevice() {
  ...
  if (meeting) {
    ...
    getMediaStreams({ sendAudio, receiveAudio }, { audio })
      ...
      .catch(error => {
        console.log(
          "MeetingControls#setAudioInputDevice :: Unable to set audio input device"
        );
        console.error(error);
      });
  } else {
...
function setAudioOutputDevice() {
  const audioOutputDevice =
    getOptionValue(sourceDevicesAudioOutput) || "default";

  meetingStreamsRemoteAudio
    .setSinkId(audioOutputDevice)
    .then(() => {
      console.log(
        `MeetingControls#setAudioOutput() :: successfully set audio output to: ${audioOutputDevice}`
      );
    })
    .catch(error => {
      console.log(
        "MeetingControls#setAudioOutput() :: Error setting audio output!"
      );
      console.error(error);
    });
}
...
function toggleSendAudio() {
  ...
  if (!meeting) {
    console.log(
      "MeetingControls#toggleSendAudio() :: no valid meeting object!"
    );
  ...
  if (meeting.isAudioMuted()) {
    meeting
      ...
      .then(() => {
        ...
        console.log(
          "MeetingControls#toggleSendAudio() :: Successfully unmuted audio!"
        );
      })
      .catch(handleError);
  } else {
    meeting
      ...
      .then(() => {
        ...
        console.log(
          "MeetingControls#toggleSendAudio() :: Successfully muted audio!"
        );
      })
      .catch(handleError);
  }
...
function toggleSendVideo() {
  ...
  if (!meeting) {
    console.log(
      "MeetingControls#toggleSendVideo() :: no valid meeting object!"
    );
  ...
  if (meeting.isVideoMuted()) {
    meeting
      ...
      .then(() => {
        ...
        console.log(
          "MeetingControls#toggleSendVideo() :: Successfully unmuted video!"
        );
      })
      .catch(handleError);
  } else {
    meeting
      ...
      .then(() => {
        ...
        console.log(
          "MeetingControls#toggleSendVideo() :: Successfully muted video!"
        );
      })
      .catch(handleError);
  }
...
async function startScreenShare() {
  ...
  try {
    ...
    console.log(
      "MeetingControls#startScreenShare() :: Successfully started sharing!"
    );
  } catch (error) {
    toggleSourcesSendShareStatus.innerText = "Error! See console for details.";
    console.log(
      "MeetingControls#startScreenShare() :: Error starting screen share!"
    );
    console.error(error);
  }
}
...
async function stopScreenShare() {
  ...
  try {
    ...
    console.log(
      "MeetingControls#stopScreenShare() :: Successfully stopped sharing!"
    );
  } catch (error) {
    toggleSourcesSendShareStatus.innerText = "Error! See console for details.";
    console.log(
      "MeetingControls#stopScreenShare() :: Error stopping screen share!"
    );
    console.error(error);
  }
}
...
function setLocalMeetingQuality() {
  ...
  meeting
    ...
    .then(() => {
      ...
      console.log(
        "MeetingControls#setLocalMeetingQuality() :: Meeting quality level set successfully!"
      );
    })
    .catch(error => {
      toggleSourcesQualityStatus.innerText =
        "MeetingControls#setLocalMeetingQuality() :: Error setting quality level!";
      console.log(
        "MeetingControls#setLocalMeetingQuality() :: Error meeting quality!"
      );
      console.error(error);
    });
}
...
function setRemoteMeetingQuality() {
  ...
  meeting
    ...
    .then(() => {
      ...
      console.log(
        "MeetingControls#setRemoteMeetingQuality :: Meeting quality level set successfully!"
      );
    })
    .catch(error => {
      toggleSourcesQualityStatus.innerText =
        "MeetingControls#setRemoteMeetingQuality :: Error setting quality level!";
      console.log(
        "MeetingControls#setRemoteMeetingQuality :: Error meeting quality!"
      );
      console.error(error);
    });
}
...
function setMeetingQuality() {
  ...
  meeting
    ...
    .then(() => {
      ...
      console.log(
        "MeetingControls#setMeetingQuality :: Meeting quality level set successfully!"
      );
    })
    .catch(error => {
      toggleSourcesQualityStatus.innerText =
        "MeetingControls#setMeetingQuality() :: Error setting quality level!";
      console.log(
        "MeetingControls#setMeetingQuality :: Error meeting quality!"
      );
      console.error(error);
    });
}
...
const currentDeviceDetailsElm = document.querySelector(
  "#current-device-details"
);
const currentDeviceAudioStateElm = document.querySelector(
  "#current-device-audio-state"
);
...
function selectDevice(device) {
  ...
  currentDeviceAudioStateElm.innerText =
    "Device audio state has not been queried yet";
}
...
function deviceGetAudioState() {
  ...
  webex.devicemanager.getAudioState().then(state => {
...
function refreshDevicesList() {
  ...
  webex.devicemanager.refresh().then(devices => {
    if (devices.length === 0) {
      devicesListItemsElm.innerText =
    ...
    devices.forEach(device =>
      devicesListItemsElm.appendChild(generateMeetingsDevicesListItem(device))
    );
  });
}
  ...
  webex.devicemanager
    ...
    .then(results => {
      results.forEach(device =>
        findDevicesListElm.appendChild(
...
function changeAudioState(command) {
  webex.devicemanager[command]().then(res => {
    console.log(res);
...
function claimPersonalMeetingRoom() {
  ...
  webex.meetings.personalMeetingRoom
    .claim(pmrId, pmrPin)
    .then(pmr => {
